...
import SidebardSalud from '../../Utils/SidebardSalud';
        ...
        <div className="drawer drawer-end">
            ...
            <div className="drawer-side">
                ...
                <ul className="menu p-4 w-80 min-h-full text-base-content bg-black">
                    ...
                    <li><a><Link className='flex hover:text-white' to="/"><RiLogoutBoxFill className='text-2xl'/><span className='text-xl'>Mi Cuenta</span></Link></a></li>
                    <div className=''></div>
                    ...
                    <div className="collapse rounded-md">
                        ...
                        <div className="collapse-title bg-black text-white peer-checked:bg-neutral-700 peer-checked:text-neutral-400">
                            <div className='text-2xl pt-2'>Observar</div>
                        </div>
